...
def as_markdown():
    ...
    lines += [
        ...
        "### How to deliver",
        "",
        "**Working locally in this repo, with the owner present?** Commit and",
        "push to the default branch yourself when the work is done and the",
        "tests pass. No branch, no pull request — a PR exists so somebody who",
        "was not there can review; the owner watched you do it. Then mark the",
        "work finished:",
        "",
        "```",
        "~/project-radar/radar task done <task-id>",
        "```",
        "",
        "**That last step is not optional.** Nothing else observes that a task",
        "is finished. Skip it and the board keeps asking for work that is",
        "already shipped — that is how it reached 440 open tasks, most of them",
        "done. Closing the task is part of finishing, not bookkeeping after it.",
        "",
        "If a requirement has no automated check — an account onboarded, an",
        "agreement signed, a purchase tested on a real device — answer it by",
        "id under `manual:` for that project in `~/project-radar/projects.yaml`.",
        "That is the only way such an item can ever close, and the answer",
        "sticks: a scan never overwrites it.",
        "",
        "Still stop and ask before anything the owner would want to decide:",
        "money moving, data being destroyed, something customer-facing going",
        "out. Committing your own finished work is not one of those.",
        "",
        "**Working in a sandbox, a cloud run, or from a radar issue with nobody",
        "watching?** Then the pull request is how the work survives, and the",
